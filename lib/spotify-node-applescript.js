...
var execScriptWithBooleanResponse = function(scriptName, callback){
    return execScript(scriptName, function(error, response) {
        if (!error) {
...
exports.isRunning = function(callback) {
    return execScriptWithBooleanResponse('isRunning', callback);
};

exports.isRepeating = function(callback){
    return execScriptWithBooleanResponse('isRepeating', callback);
};

exports.isShuffling = function(callback){
    return execScriptWithBooleanResponse('isShuffling', callback);
};
