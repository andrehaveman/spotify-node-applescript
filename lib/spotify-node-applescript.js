...
var scripts = {
    track : [
        ...
        'set ctrack to ctrack & ",\\"disc number\\": " & current track\'s disc number',
        'set ctrack to ctrack & ",\\"duration\\": " & current track\'s duration',
        'set ctrack to ctrack & ",\\"played count\\": " & current track\'s played count',
        'set ctrack to ctrack & ",\\"track number\\": " & current track\'s track number',
        ...
        'set ctrack to ctrack & ",\\"album artist\\": \\"" & current track\'s album artist & "\\""',
        'set ctrack to ctrack & ",\\"spotify url\\": \\"" & current track\'s spotify url & "\\""',
