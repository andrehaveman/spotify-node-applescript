...
exports.muteVolume = function(callback){
    applescript.execFile(__dirname + '/scripts/get_state.applescript', createJSONResponseHandler(function(err, state) {
...
exports.unmuteVolume = function(callback){
    if(mutedVolume !== null) {
        exports.setVolume(mutedVolume, callback);
    }
};
