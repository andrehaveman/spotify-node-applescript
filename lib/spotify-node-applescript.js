...
var scripts = {
    ...
    volumeFade:
        'property targetVolume : %s\n' +
        'property fadetime : %s\n' +
        'property stopWhenDone : %s\n' +
...
exports.getVolume = function(callback){
    return execScript('getVolume', callback);
};
...
exports.volumeFade = function(volume, fadeTime, stopWhenDone, callback){
    mutedVolume = null;
    return execScript('volumeFade', [volume, fadeTime, stopWhenDone], callback);
};
